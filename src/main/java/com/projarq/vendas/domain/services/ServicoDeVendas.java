...
import com.projarq.vendas.domain.repository.IOrcamentoRepositorio;
...
public class ServicoDeVendas {
    ...
    public Orcamento recuperaOrcamentoPorId(long id) {
        return this.orcamentos.recuperaPorId(id);
    }

    public Orcamento criaOrcamento(Pedido pedido) {
    ...
    public Orcamento efetivaOrcamento(long id) {
        ...
        for (ItemPedido itemPedido:orcamento.getItens()) {
